...
function init_plugin() {
    ...
    // Initialize Offerte module if enabled
    if ( Modules_Settings::is_offerte_enabled() ) {
        require_once BOSSIER_CALC_PLUGIN_DIR . 'includes/offerte/class-offerte-module.php';
        Offerte\Offerte_Module::get_instance();
    }
}
