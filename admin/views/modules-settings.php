...
<div class="wrap boost-modules-settings">
            ...
            <a href="<?php echo esc_url( add_query_arg( 'tab', $tab_id, $base_url ) ); ?>"
               class="nav-tab <?php echo $current_tab === $tab_id ? 'nav-tab-active' : ''; ?>">
                ...
                <?php if ( 'woopages' === $tab_id && ! empty( $settings['woopages_enabled'] ) ) : ?>
                    <span class="boost-module-badge boost-module-active"><?php esc_html_e( 'Actief', 'bossier-calculator' ); ?></span>
                <?php endif; ?>
                <?php if ( 'offerte' === $tab_id && ! empty( $settings['offerte_module_enabled'] ) ) : ?>
                    <span class="boost-module-badge boost-module-active"><?php esc_html_e( 'Actief', 'bossier-calculator' ); ?></span>
                <?php endif; ?>
            </a>
        <?php endforeach; ?>
    ...
    <form method="post" action="options.php" class="boost-settings-form">
        ...
        <?php if ( 'general' === $current_tab ) : ?>
            ...
            <div class="boost-settings-section">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row"><?php esc_html_e( 'Offerte Module', 'bossier-calculator' ); ?></th>
                        <td>
                            <label class="boost-toggle">
                                <input type="checkbox"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_module_enabled]"
                                       value="1"
                                       <?php checked( $settings['offerte_module_enabled'] ); ?>>
                                <span class="boost-toggle-slider"></span>
                            </label>
                            <p class="description"><?php esc_html_e( 'Schakel de Offerte module in voor het aanmaken, verzenden en accepteren van offertes met digitale handtekening.', 'bossier-calculator' ); ?></p>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <?php elseif ( 'offerte' === $current_tab ) : ?>
            <!-- Offerte Tab -->
            <?php if ( empty( $settings['offerte_module_enabled'] ) ) : ?>
                <div class="boost-settings-section">
                    <div class="boost-module-inactive-notice">
                        <span class="dashicons dashicons-warning"></span>
                        <h3><?php esc_html_e( 'Offerte Module is niet actief', 'bossier-calculator' ); ?></h3>
                        <p><?php esc_html_e( 'Activeer de Offerte module in het Algemeen tabblad om deze instellingen te configureren.', 'bossier-calculator' ); ?></p>
                        <a href="<?php echo esc_url( add_query_arg( 'tab', 'general', $base_url ) ); ?>" class="button button-primary">
                            <?php esc_html_e( 'Ga naar Algemeen', 'bossier-calculator' ); ?>
                        </a>
                    </div>
                ...
                <div class="boost-settings-section">
                    <h2><?php esc_html_e( 'Wat doet de Offerte Module?', 'bossier-calculator' ); ?></h2>
                    <div class="boost-info-box">
                        <h4><?php esc_html_e( 'Offerte Flow', 'bossier-calculator' ); ?></h4>
                        <ol>
                            <li><?php esc_html_e( 'Maak een offerte aan met producten uit de calculator', 'bossier-calculator' ); ?></li>
                            <li><?php esc_html_e( 'Verzend de offerte per e-mail met PDF bijlage', 'bossier-calculator' ); ?></li>
                            <li><?php esc_html_e( 'Klant bekijkt de offerte via een beveiligde link', 'bossier-calculator' ); ?></li>
                            <li><?php esc_html_e( 'Klant accepteert met digitale handtekening', 'bossier-calculator' ); ?></li>
                            <li><?php esc_html_e( 'WooCommerce bestelling wordt automatisch aangemaakt', 'bossier-calculator' ); ?></li>
                        </ol>
                    </div>
                </div>
            <?php else : ?>
                <!-- Offerte Module Active - Show Settings -->

                <!-- Bedrijfsgegevens -->
                <div class="boost-settings-section">
                    <h2><?php esc_html_e( 'Bedrijfsgegevens', 'bossier-calculator' ); ?></h2>
                    <p class="description"><?php esc_html_e( 'Deze gegevens worden gebruikt op offertes en in e-mails.', 'bossier-calculator' ); ?></p>

                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Bedrijfsnaam', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_name]"
                                       value="<?php echo esc_attr( $settings['offerte_company_name'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Adres', 'bossier-calculator' ); ?></th>
                            <td>
                                <textarea name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_address]"
                                          rows="3"
                                          class="large-text"><?php echo esc_textarea( $settings['offerte_company_address'] ); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Telefoon', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_phone]"
                                       value="<?php echo esc_attr( $settings['offerte_company_phone'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'KVK-nummer', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_kvk]"
                                       value="<?php echo esc_attr( $settings['offerte_company_kvk'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'BTW-nummer', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_btw]"
                                       value="<?php echo esc_attr( $settings['offerte_company_btw'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'IBAN', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_iban]"
                                       value="<?php echo esc_attr( $settings['offerte_company_iban'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Logo', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_company_logo]"
                                       value="<?php echo esc_attr( $settings['offerte_company_logo'] ); ?>"
                                       class="small-text"
                                       placeholder="<?php esc_attr_e( 'Attachment ID', 'bossier-calculator' ); ?>">
                                <p class="description"><?php esc_html_e( 'WordPress Media Library attachment ID van het bedrijfslogo. Laat leeg om het PDF logo te gebruiken.', 'bossier-calculator' ); ?></p>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="boost-settings-section">
                    <h2><?php esc_html_e( 'Offerte Instellingen', 'bossier-calculator' ); ?></h2>

                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Offerte Prefix', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_prefix]"
                                       value="<?php echo esc_attr( $settings['offerte_prefix'] ); ?>"
                                       class="small-text">
                                <p class="description"><?php esc_html_e( 'Prefix voor offertenummers, bijv. BS-2026-0001.', 'bossier-calculator' ); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Standaard Geldigheid', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="number"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_default_validity]"
                                       value="<?php echo esc_attr( $settings['offerte_default_validity'] ); ?>"
                                       class="small-text"
                                       min="1"
                                       step="1">
                                <span class="description"><?php esc_html_e( 'dagen', 'bossier-calculator' ); ?></span>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Standaard Herinnering', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="number"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_default_reminder]"
                                       value="<?php echo esc_attr( $settings['offerte_default_reminder'] ); ?>"
                                       class="small-text"
                                       min="0"
                                       step="1">
                                <span class="description"><?php esc_html_e( 'dagen na verzending (0 = geen herinnering)', 'bossier-calculator' ); ?></span>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Betaalmethoden', 'bossier-calculator' ); ?></th>
                            <td>
                                <?php
                                $payment_options = \Bossier\Calculator\Offerte\Offerte_Settings::get_payment_method_options();
                                $selected_methods = $settings['offerte_payment_methods'] ?? array( 'ideal_invoice' );
                                foreach ( $payment_options as $key => $label ) :
                                ?>
                                    <label style="display: block; margin-bottom: 5px;">
                                        <input type="checkbox"
                                               name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_payment_methods][]"
                        ...
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Algemene Voorwaarden URL', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="url"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_terms_url]"
                        ...
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Voorwaarden Tekst', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_terms_text]"
                                       value="<?php echo esc_attr( $settings['offerte_terms_text'] ); ?>"
                                       class="large-text">
                                <p class="description"><?php esc_html_e( 'Tekst bij de voorwaarden checkbox op de publieke offertepagina.', 'bossier-calculator' ); ?></p>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <!-- E-mail Instellingen -->
                <div class="boost-settings-section">
                    <h2><?php esc_html_e( 'E-mail Instellingen', 'bossier-calculator' ); ?></h2>

                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Afzendernaam', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_sender_name]"
                                       value="<?php echo esc_attr( $settings['offerte_sender_name'] ); ?>"
                                       class="regular-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Afzender E-mail', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="email"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_sender_email]"
                    ...
                    <h3><?php esc_html_e( 'Offerte Verzonden E-mail', 'bossier-calculator' ); ?></h3>
                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Onderwerp', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_email_sent_subject]"
                                       value="<?php echo esc_attr( $settings['offerte_email_sent_subject'] ); ?>"
                                       class="large-text">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Inhoud', 'bossier-calculator' ); ?></th>
                            <td>
                                <textarea name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_email_sent_body]"
                                          rows="8"
                    ...
                    <h3><?php esc_html_e( 'Herinnering E-mail', 'bossier-calculator' ); ?></h3>
                    <table class="form-table">
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Onderwerp', 'bossier-calculator' ); ?></th>
                            <td>
                                <input type="text"
                                       name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_email_reminder_subject]"
                        ...
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Inhoud', 'bossier-calculator' ); ?></th>
                            <td>
                                <textarea name="<?php echo esc_attr( \Bossier\Calculator\Modules_Settings::OPTION_NAME ); ?>[offerte_email_reminder_body]"
                                          rows="8"
                    ...
                    <div class="boost-info-box" style="margin-top: 15px;">
                        <h4><?php esc_html_e( 'Beschikbare Placeholders', 'bossier-calculator' ); ?></h4>
                        <p><code>{customer_name}</code> — <?php esc_html_e( 'Klantnaam', 'bossier-calculator' ); ?></p>
                        <p><code>{company_name}</code> — <?php esc_html_e( 'Uw bedrijfsnaam', 'bossier-calculator' ); ?></p>
                        <p><code>{quote_number}</code> — <?php esc_html_e( 'Offertenummer', 'bossier-calculator' ); ?></p>
                        <p><code>{quote_url}</code> — <?php esc_html_e( 'Link naar offertepagina', 'bossier-calculator' ); ?></p>
                        <p><code>{valid_until}</code> — <?php esc_html_e( 'Geldig tot datum', 'bossier-calculator' ); ?></p>
                        <p><code>{total}</code> — <?php esc_html_e( 'Totaalbedrag', 'bossier-calculator' ); ?></p>
                    </div>
                </div>
            <?php endif; ?>
